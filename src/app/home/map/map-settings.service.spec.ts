...
fdescribe('MapSettingsService', () => {
    ...
    it('should determine if route meets current distance settings', () => {
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeTrue()
    ...
    it('should determine if route meets current skills difficulty settings', () => {
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeTrue()
    ...
    it('should determine if route meets current fitness difficulty settings', () => {
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeTrue()
        service.currentSettings = { fitnessEasy: false, fitnessMedium: false, fitnessHard: true }
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeTrue()
        service.currentSettings = { fitnessEasy: false, fitnessMedium: true, fitnessHard: true }
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeTrue()
        service.currentSettings = { fitnessEasy: true, fitnessMedium: false, fitnessHard: true }
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeTrue()
        service.currentSettings = { fitnessEasy: true, fitnessMedium: true, fitnessHard: true }
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeTrue()
        service.currentSettings = { fitnessEasy: false, fitnessMedium: false, fitnessHard: false }
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeFalse()
        service.currentSettings = { fitnessEasy: true, fitnessMedium: false, fitnessHard: false }
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeFalse()
        service.currentSettings = { fitnessEasy: true, fitnessMedium: true, fitnessHard: false }
        expect(service.routeMeetsCurrentSettings(mockRouteProperties)).toBeFalse()
    })
})
