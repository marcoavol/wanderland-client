            ...
            <div>
                    ...
                    ${numberOfStagesOnRoute > 1 ?
                        `<div class="d-flex justify-content-evenly">
                            <p>
                                ...
                                Dauer: ${this.unitUtilsService.convertToUnitString(routeProperties.ZeitStZiR || routeProperties.ZeitZiStR, 'DaysHoursMinutes', true)}
                            </p>
                            <p>
                ...
                <div class="w-100 text-center pt-1">
                    ...
                    <div class="d-flex justify-content-evenly">
                        <p>
                            <i class="bi bi-stopwatch"></i>
                            Dauer: ${this.unitUtilsService.convertToUnitString(stageProperties.ZeitStZiE || stageProperties.ZeitZiStE, 'DaysHoursMinutes', true)}
                        </p>
                        <p>
                            <i class="bi bi-code"></i>
